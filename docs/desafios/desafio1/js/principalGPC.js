...
function llenarGPC() {
    ...
    var campo_error_ideal = document.getElementById("e_rel_gpc_ideal");
    var campo_error_ideal_por = document.getElementById("e_rel_gpc_por_ideal")
    ...
    var campo_error_estres = document.getElementById("e_rel_gpc_estres");
    var campo_error_estres_por = document.getElementById("e_rel_gpc_por_estres")
    ...
    var campo_error_mal = document.getElementById("e_rel_gpc_mal");
    var campo_error_mal_por = document.getElementById("e_rel_gpc_por_mal")
