// jacobi.js
function calcularIteracionesSor(A, b,w=1.2) {
    var resultados = [];
    var x = 0, y = 0, z = 0;
    ...
    for (var k = 1; k <= 10; k++) {
        ...
        x = (1-w) * xAnt + w * (b[0] - (A[0][1] * y) - (A[0][2] * z)) / A[0][0];
        y = (1-w) * yAnt + w * (b[1] - (A[1][0] * x) - (A[1][2] * z)) / A[1][1];
        z = (1-w) * zAnt + w * (b[2] - (A[2][0] * x) - (A[2][1] * y)) / A[2][2];
